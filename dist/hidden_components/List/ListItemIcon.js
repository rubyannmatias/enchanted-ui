...
exports.getMuiListItemIconThemeOverrides = void 0;
const react_1 = __importDefault(require("react"));
const ListItemIcon_1 = __importDefault(require("@mui/material/ListItemIcon"));
const getMuiListItemIconThemeOverrides = () => {
    return {
        MuiListItemIcon: {
            styleOverrides: {
                root: () => {
...
exports.getMuiListItemIconThemeOverrides = getMuiListItemIconThemeOverrides;
